...
export default function MyName(props: { finishedLoading: boolean }) {
  ...
  return (
    ...
    >
      ...
      >
        I create innovative solutions for your software needs.
      </motion.h2>
      ...
      >
        ...
        specializing in building innovative solutions for your
        <span className="text-AAsecondary">development</span> needs.
      </motion.h3>
      <motion.div
        initial={{ y: 10, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
