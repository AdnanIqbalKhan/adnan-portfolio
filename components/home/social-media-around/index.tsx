...
export default function SocialMediaEmail(
  props: Readonly<{ finishedLoading: boolean }>
) {
  return (
    <>
      <motion.div
      ...
      >
        <div className="flex flex-col space-y-8 justify-center items-center">
          <div className="flex flex-col justify-center items-center space-y-5">
            {/* Github Icon */}
            <IconClickableWithAnimation Icon={GithubIcon} href={GITHUB_URL} />
            {/* Linkedin icon */}
            ...
            />
            {/* Youtube Icon */}
            <IconClickableWithAnimation Icon={YoutubeIcon} href={YOUTUBE_URL} />
          </div>
